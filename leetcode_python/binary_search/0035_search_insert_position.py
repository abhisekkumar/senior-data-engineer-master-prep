...
Restate the Problem:
    Explain the input, expected output, and objective for Search Insert Position before coding.
...
Recognition clue: “Find target, or where it should be inserted.”
Platform equivalent: Insert new partition / ordered key lookup
