...
Restate the Problem:
    Explain the input, expected output, and objective for Koko Eating Bananas before coding.
...
"""
Recognition Clue:
minimum / maximum / smallest / largest / capacity / speed / rate
...
Return the minimum speed so she can finish within h hours.
