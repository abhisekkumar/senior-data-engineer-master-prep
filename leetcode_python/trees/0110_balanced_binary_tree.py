...
Restate the Problem:
    Explain the input, expected output, and objective for Balanced Binary Tree before coding.
...
For every node, the difference between the height of the left subtree and the right subtree is at most 1.
